...
export async function GET(request: Request) {
  ...
  if (role === "sales_agent") {
    ...
    // Team leaders see their team's agents
  ...
  } else if (agentId && (role === "sales_manager" || role === "business_unit_head" || role === "ceo")) {
    // Managers and above can filter by specific agent
